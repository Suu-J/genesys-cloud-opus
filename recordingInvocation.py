...
conversation_id = '9caf4689-f97e-43af-ad26-191db89cf591' # str | Conversation ID
...
format_id = 'OGG_OPUS' # str | The desired media format. Valid values:WAV,WEBM,WAV_ULAW,OGG_VORBIS,OGG_OPUS,MP3,NONE. (optional) (default to 'WEBM')
media_formats = ['OGG_OPUS'] # list[str] | All acceptable media formats. Overrides formatId. Valid values:WAV,WEBM,WAV_ULAW,OGG_VORBIS,OGG_OPUS,MP3. (optional)
