...
# Read conversation ids and their statuses from the CSV file and store the result in a list
conversations = []
with codecs.open('test_ids.csv', 'r', 'utf-8-sig') as csvfile:
    reader = csv.DictReader(csvfile)
    conversations = [row for row in reader]  # Load all conversations

# Append to the recording counts file only new successful entries
...
try:
    ...
    pass  # File already exists, we'll append without writing the header
...
# Write all updates back to the original test_ids.csv file
